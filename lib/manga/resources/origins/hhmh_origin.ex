defmodule Manga.Res.HHMHOrigin do
      ...
      list =
        ...
        |> Enum.map(fn linkNode ->
          Info.create(
            ...
            url: "http://www.hhmmoo.com" <> (linkNode |> Floki.attribute("href") |> List.first())
          )
        end)
      ...
      list =
        ...
        |> Enum.map(fn linkNode ->
          Stage.create(
            ...
            url: "http://www.hhmmoo.com" <> (Floki.attribute(linkNode, "href") |> List.first())
          )
        end)
